...
from friends.views import createFriendRequest, acceptFriendRequest,denyFriendRequest,removeFriend, blockUser, unblockUser, getFriends, getpendingReq 
app_name = 'friends'
urlpatterns = [
    ...
    path('pendingrequests/', getpendingReq, name= 'penreq')
]
